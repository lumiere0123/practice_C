...
def type_token_ratio(text):
    ...
    ###  unique_words = get_words(text)
    ###  word_count = create_word_count(text)
    ###  total = 0
    ###  for unique_word in unique_words:
    ###      total += get_count(unique_word)
    ###  # unique word # / total word #
    ###  len(unique_words)/ total
...
def split_on_separators(original, separators):
    ...
    #original = clean_up(original)
    #"Hooray! Finally, we're done.", "!,"
    #list1 = []
    #for separator in separators:
    ##         ,
    #    list1.extend(original.split(separator))
    #                 -------------------------
    #                ["Hooray"," Finally, we're done."]
    #    list1=["Hooray"," Finally, we're done."] 
    #return list1
...
def avg_sentence_length(text):
    ...
    # [ a, b, c]
    word_count_list = create_word_count(text)
    # [ a,3, b,2, c,1]
    ...
    for word in word_list:
        total_word_counts += get_count(word, word_count_list) * len(word)
        
    splited_sent = split_on_separators("\n".join(word_list), "!?.")
    total_sent_counts = len(splited_sent)
    return total_word_counts / total_sent_counts 
...
def avg_sentence_complexity(text):
    ...
    #  total # of phrase / total # of sentences
